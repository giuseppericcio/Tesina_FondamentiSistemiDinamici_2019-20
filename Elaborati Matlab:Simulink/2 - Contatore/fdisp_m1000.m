...
disp(' ')
disp('Valore assoluto del numero maggiore di 999')
end

n1000=mod(n,1000);

if n1000==0,close all;end

cc=[floor(n1000./100) floor((n1000 - floor(n1000./100)*100)./10) mod(n1000,10)];
CC=[];
